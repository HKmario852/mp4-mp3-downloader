...
"mp3"=>"M9,18 L9,5 L21,2 L21,15 M9,8 L21,5 M9,18 C9,22 2,22 2,19 C2,16 9,15 9,18 M21,15 C21,19 14,19 14,16 C14,13 21,12 21,15",
    ...
    public static Grid Hint(TextBox input,string hint){var g=new Grid();input.MinHeight=Math.Max(input.MinHeight,44);input.Padding=new Thickness(12,0,12,0);input.VerticalContentAlignment=VerticalAlignment.Center;g.Children.Add(input);var t=new TextBlock{Text=hint,VerticalAlignment=VerticalAlignment.Center,Margin=new Thickness(16,0,14,0),IsHitTestVisible=false};t.SetResourceReference(TextBlock.ForegroundProperty,"Muted");g.Children.Add(t);void Update()=>t.Visibility=string.IsNullOrEmpty(input.Text)?Visibility.Visible:Visibility.Collapsed;input.TextChanged+=(_,_)=>Update();Update();System.Windows.Automation.AutomationProperties.SetHelpText(input,hint);return g;}
